...
if __name__ == "__main__":
    ...
    general.add_argument("--use_vector", action=argparse.BooleanOptionalAction, default=False)
    ...
    while (line:=input("Enter your query (type 'Exit' to exit or hit ctrl-c)")) != "Exit":
        query = line.rstrip()
